...
func ProfilePage(email string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</header><hr><main><div class=\"column left\">Menu-col1\r<hr><table><tr><button type=\"button\">POKAŻ DANE</button></tr><tr><button type=\"button\">ZMIEN HASLO</button></tr><tr><button type=\"button\">ZMIEN EMAIL</button></tr><tr><button type=\"button\" id=\"deleteButton\">USUN</button></tr><script>\r\n                        document.getElementById('deleteButton').addEventListener('click', function() {\r\n                        fetch('http://localhost:1000/profile', {\r\n                            method: 'DELETE',\r\n                        })\r\n                        .then(response => {\r\n                            if (!response.ok) {\r\n                            throw new Error('Network response was not ok');\r\n                            }\r\n                            // Tutaj możesz obsłużyć sukces usuwania\r\n                        })\r\n                        .catch(error => {\r\n                            console.error('There was a problem with the DELETE operation:', error);\r\n                        });\r\n                        });\r\n                    </script></table></div><div class=\"column right\">Menu-col2\r<hr></div></main><hr><footer><p>Author: Hege Refsnes<br><a>hege@example.com</a></p></footer></body></html>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
